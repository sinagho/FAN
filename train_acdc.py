...
args.exp = 'FAN_main_newversion_250_withoutFAN' + str(args.img_size)
...
net = Model(
            ...
            decoder_prompt=args.decoder_prompt,# Ok
        ).cuda(0)     
...
#         lr_ = base_lr
    ...
    if vl_avg_dcs >= best_dcs_vl - 0.25:
        te_avg_dcs, te_avg_hd = inference(args, net, testloader, args.test_save_dir, epoch+1)
    ...
    print(f"epoch:{epoch:03d}/{args.max_epochs}, loss:{train_loss/len(train_dataset):0.5f}, lr:{lr_:0.6f}, vl_DCS:{vl_avg_dcs*100:0.3f}, te_DCS:{te_avg_dcs*100:0.3f}, te_HD95:{te_avg_hd:0.2f}")
